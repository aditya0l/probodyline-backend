...
export class QuotationsController {
  ...
  findAll(
    ...
    @Query('quoteDateFrom') quoteDateFrom?: string,
    @Query('quoteDateTo') quoteDateTo?: string,
    @Query('bookingDateFrom') bookingDateFrom?: string,
    @Query('bookingDateTo') bookingDateTo?: string,
    @Query('dispatchDateFrom') dispatchDateFrom?: string,
    @Query('dispatchDateTo') dispatchDateTo?: string,
    @Query('installationDateFrom') installationDateFrom?: string,
    @Query('installationDateTo') installationDateTo?: string,
    @Query('inaugurationDateFrom') inaugurationDateFrom?: string,
    @Query('inaugurationDateTo') inaugurationDateTo?: string,
