    ...
    if (!existing) {
      await prisma.product.create({
        data: {
          ...
          cousinMachine: productData.cousinMachine ? [productData.cousinMachine] : [],
          orderTogether: productData.orderTogether ? [productData.orderTogether] : [],
          swapMachine: productData.swapMachine ? [productData.swapMachine] : [],
